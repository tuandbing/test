...
<script>
    ...
    $(function () {
        ...
        $("[value='编辑']").click(function (){
            ...
            $.ajax({
                //提交到后端的地址
                url: "http://localhost:8080/ssm/user/update",
                //提交的方式
                type: "post",
                //提交到后端的数据
                data: $("form").serialize(),
...
<div class="container container-round">
    ...
    <form class="form-horizontal" role="form" style="margin-top: 20px">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="name" name="name" placeholder="学生姓名" value="${user.name}">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="password" class="form-control" id="password" name="password" placeholder="密码" value="${user.password}">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" value="${user.address}" id="address" name="address" placeholder="居住地址">
            </div>
        </div>
